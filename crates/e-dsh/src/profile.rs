...
//! backend I/O counters, and Tracy zones.
//!
//! - `DSH_TUI_TRACY=1` + feature `tracy` enables Tracy spans.
//! - `DSH_TUI_TIMING=1` prints startup phase timings.
//! - `DSHE_FRAME_TIMING=1` prints bounded aggregate frame metrics.
