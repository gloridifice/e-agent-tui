...
- Compaction routing remains adapter-owned; its user-wide persistence is defined by the configuration contract. Manual temporary selection MUST restore and verify the prior route before releasing dependent requests.
