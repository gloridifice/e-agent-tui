...
- [ ] 4.4 Perform a manual Windows Terminal smoke check in both frontends for cross-region copy, wide glyphs, streaming, clipboard feedback, and focus/resize cancellation.
