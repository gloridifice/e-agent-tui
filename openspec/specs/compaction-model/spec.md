# compaction-model Specification

## Purpose
Select a separate compaction model while preserving conversation routing, with backend-specific automatic compaction behavior and safe Pi restoration.
