...
- The composer has one visible text row and keeps the cursor's wrapped row in view without changing multiline editing, atomic paste, or submission semantics. Input Pages retain their own height policy.
